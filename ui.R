                                ...
                                column(2,
                                       div(class="panel panel-default", 
                                           div(class="panel-body",  width = "600px",
                                               ...
                                               div(
                                                   tags$h5("Syerd Zaid Ali"),
                                                   tags$h6( tags$i("Visionary & Project Lead"))
                                               ),
                                               div(
                                                   "My County career path started as a Technical Product Analyst Intern."
                                               )
                                           )
                                       )
                                ),
                                ...
                                column(2,
                                       div(class="panel panel-default",
                                           div(class="panel-body",  width = "600px", 
                                               ...
                                               div(
                                                   tags$h5("Shreyash"),
                                                   tags$h6( tags$i(" 4 Star Coder"))
                                               ),
                                               div(
                                                   "My County career path will start as a Data Analyst."
                                               )
                                           )
                                       )
                                ),
                                           ...
                                           div(class="panel-body",  width = "600px", 
                                               ...
                                               div(
                                                   tags$img(src = "man.svg", 
                                                            width = "50px", height = "50px")),
                                               div(
                                                   tags$h5("Rizwan Sadique"),
                                                   tags$h6( tags$i("Writer"))
                                               ),
                                               div(
                                                   "My County career path will start as Technical Writer ."
                                               )
                                           )
                                       )
                                ),
